...
1. Click **Sign In** and choose the option to create a new account.
2. Provide your name, email address, phone number, and password.
3. Verify your email using the code sent to your inbox.
4. Verify your phone number by entering the SMS code sent to your mobile.
5. Once verified, you can place orders, view your order history, and submit feedback.

## 3. Placing an Order

1. Go to **Products** to browse available items.
2. Add products to your cart.
3. Click **Cart** to review your selected items.
